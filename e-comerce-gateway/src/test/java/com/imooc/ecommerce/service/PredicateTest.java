...
public class PredicateTest {
    ...
    /**
     * test方法主要用于参数符不符合规则，返回值是boolean
     */
    @Test
    ...
    /**
     * and 方法等同于我们的逻辑与 && 存在短路特性，需要满足所有条件
     */
    @Test
    ...
    public void testPredicateNegate(){
        ...
        MICRO_SERVICE.stream().filter(letterStartWith.negate()
        ).forEach(System.out::println);
    }

    /**
     * isEqual 类似于 equals(),区别于：先判断对象是否为NULL,不为NULL 在使用equals()进行比较
     */
    @Test
